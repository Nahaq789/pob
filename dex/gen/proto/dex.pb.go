...
const file_proto_dex_proto_rawDesc = "" +
	...
	"\n" +
	"ability_id\x18\x01 \x01(\x05R\tabilityId\x12!\n" +
	"\fability_name\x18\x02 \x01(\tR\vabilityName2\x88\x02\n" +
	"\n" +
	"DexService\x12:\n" +
	"\n" +
	...
	"\n" +
	"GetAbility\x12\x16.dex.GetAbilityRequest\x1a\x14.dex.AbilityResponseB\rZ\vpob/dex/genb\x06proto3"
...
var file_proto_dex_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
...
var file_proto_dex_proto_depIdxs = []int32{
	...
	1, // 6: dex.DexService.GetPokemon:output_type -> dex.PokemonResponse
	4, // 7: dex.DexService.GetLearnableMoves:output_type -> dex.LearnableMovesResponse
	6, // 8: dex.DexService.GetMove:output_type -> dex.MoveResponse
	8, // 9: dex.DexService.GetAbility:output_type -> dex.AbilityResponse
