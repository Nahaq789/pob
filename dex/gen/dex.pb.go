...
const file_proto_dex_proto_rawDesc = "" +
	...
	"\aGetItem\x12\x13.dex.GetItemRequest\x1a\x11.dex.ItemResponseB\rZ\vpob/dex/genb\x06proto3"
...
var file_proto_dex_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
...
var file_proto_dex_proto_depIdxs = []int32{
	...
	0,  // 2: dex.DexService.GetPokemon:input_type -> dex.GetPokemonRequest
	3,  // 3: dex.DexService.GetLearnableMoves:input_type -> dex.GetLearnableMovesRequest
	5,  // 4: dex.DexService.GetMove:input_type -> dex.GetMoveRequest
	7,  // 5: dex.DexService.GetAbility:input_type -> dex.GetAbilityRequest
	9,  // 6: dex.DexService.GetItem:input_type -> dex.GetItemRequest
	1,  // 7: dex.DexService.GetPokemon:output_type -> dex.PokemonResponse
	4,  // 8: dex.DexService.GetLearnableMoves:output_type -> dex.LearnableMovesResponse
	6,  // 9: dex.DexService.GetMove:output_type -> dex.MoveResponse
	8,  // 10: dex.DexService.GetAbility:output_type -> dex.AbilityResponse
	10, // 11: dex.DexService.GetItem:output_type -> dex.ItemResponse
